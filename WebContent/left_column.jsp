<%@ page language="java" contentType="text/html; charset=utf-8"
    pageEncoding="utf-8"%>
<jsp:useBean id="userinfo" class="com.beans.Userinfo" scope="session"/>
      		...
      		<div id="left_login">
      			...
      			%>
      				<form action="loginAction.action" method="post">
          				...
          				<input name="imageField" type="image" src="images/login_button.gif" type = "submit"/>
          			</form>
          		<%
      			}else{      				
       			...
       			%>
      			<br><br>
      			<form action="logoutAction.action" method="post">
    	...
    	<td background=images/line_04.gif></td>
      	<td>
        		<div id="left_sort">
    				...
    				<div id="sort_menu">
    				<ul id="menu">
     					<li><img src="images/sort_menu.gif" />&nbsp;&nbsp;<a class="li_sort" href="sort.jsp?id=1">日式女扇</a></li>
     					<hr size="1" />
     					<li><img src="images/sort_menu.gif" />&nbsp;&nbsp;<a class="li_sort" href="sort.jsp?id=2">仿古男扇</a></li>
     					<hr size="1" />
   						<li><img src="images/sort_menu.gif" />&nbsp;&nbsp;<a class="li_sort" href="sort.jsp?id=3">韩国扇</a></li>
   						<hr size="1" />
   						<li><img src="images/sort_menu.gif" />&nbsp;&nbsp;<a class="li_sort" href="sort.jsp?id=4">檀香扇</a></li>
   						<hr size="1" />
   						<li><img src="images/sort_menu.gif" />&nbsp;&nbsp;<a class="li_sort" href="sort.jsp?id=5">礼品广告扇</a></li>
   					</ul>
   					</div>
  				</div>
